...
public class MyFirstProgram {
    ...
    //  и добавить в созданный в предыдущем пункте запускаемый класс примеры использования метода вместо ранее созданной функции.
     ...
     //  После выполнения задания сохраните код в удаленный репозиторий и в качестве ответа на задание сообщите тренеру ссылку на последний коммит,
     //  а также можете написать любые дополнительные комментарии и вопросы.
